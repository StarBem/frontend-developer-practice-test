# Teste Prático - Frontend Developer
...
- Deve utilizar ReactJs.
- Deve utilizar gerenciados de estado global (Recoil).
...
- Se possível escreva testes unitários (Opcional).
...
- [Link Layout Figma](https://www.figma.com/design/ilj66ua4aUugidHRFQZ0hI/Starbem---Teste-Frontend-Developer?m=dev&node-id=6%3A3&t=EDWcNYxcXk46Aj1g-1)
...
- O prazo para envio do teste é de 5 dias contando a partir do momento que o nosso RH passar o teste para o candidato.
